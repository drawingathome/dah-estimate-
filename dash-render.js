      ...
      '<div id="sec-goal" style="background:#fff;border-bottom:1px solid var(--border)">',
        ...
        '<div id="sec-kpi" style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:1px;background:var(--border);border-top:1px solid var(--border)">',
          '<div style="background:#fff;padding:14px 20px">',
            ...
            '<div style="font-size:26px;font-weight:700;color:var(--dark);line-height:1"><span class="font-accent-num">' + Math.round(thisMonthRev/10000).toLocaleString() + '</span><span style="font-size:12px;font-weight:400;color:var(--sub)">만원</span></div>',
          '</div>',
          '<div style="background:#fff;padding:14px 20px">',
            ...
            '<div style="font-size:26px;font-weight:700;color:var(--dark);line-height:1"><span class="font-accent-num">' + thisMonthContracts + '</span><span style="font-size:12px;font-weight:400;color:var(--sub)">건</span></div>',
          '</div>',
          '<div style="background:#fff;padding:14px 20px">',
            ...
            '<div style="font-size:26px;font-weight:700;color:var(--dark);line-height:1"><span class="font-accent-num">' + customers.length + '</span><span style="font-size:12px;font-weight:400;color:var(--sub)">명</span></div>',
          '</div>',
        '</div>',
      '</div>',
