...
var STAGE_ALIM = {
  ...
  상담:   ['t00_reservation','tA_visit_dday','t03_estimate','t04_followup'],
  가견적: ['t03_estimate','t04_followup','tC_payment'],
...
var ALIM_META = {
  ...
  t01_survey: {label:'1. 설문지 발송', desc:'자동 · 예약확인 30분~1시간 후', tag:'자동', button:'[설문지 작성하기] → https://dah-estimate.vercel.app/survey',
    template:'안녕하세요, 드로잉엣홈입니다 🙂\n\n#{고객명}님, 쇼룸 방문 예약해 주셔서 감사해요 ✔\n방문 전 설문지를 미리 작성해 주시면\n상담 시간을 줄이고 공간에 맞는 원단을\n미리 준비해드릴 수 있어요.\n\n3분이면 충분해요.\n설문지: https://dah-estimate.vercel.app/survey'},
  // 옛 2번(방문전날)+6번(실측전날)+10번(시공전날) 통합. #{방문유형}=쇼룸/실측/시공
  tA_visit_dday: {label:'A. 방문 전날 안내', desc:'자동 · D-1', tag:'자동',
    template:'안녕하세요, 드로잉엣홈입니다 🙂\n\n#{고객명}님, 내일 #{방문유형} 예정이에요 ✔\n\n일정: #{일정}\n\n오늘 중으로 전담팀에서\n정확한 방문 시간 안내 전화드릴게요.\n\n편하게 기다려 주세요 🙂'},
  ...
  t04_followup: {label:'4. 팔로업', desc:'자동 · 상담 3일 후 · 계약금 미결제', tag:'자동',
    template:'안녕하세요, 드로잉엣홈입니다 🙂\n\n#{고객명}님, #{공간} 상담 이후 잘 지내고 계신가요?\n\n혹시 고민되시는 부분 있으시면 편하게 말씀해 주세요 ✔\n원단이나 색상, 다시 한번 같이 봐드릴 수 있어요.\n\n쇼룸에 다시 방문하셔서 확인해보시는 것도 좋아요 🙂'},
  ...
  // 나가는 안내라 공통으로 걸리는 표현.
  tC_payment: {label:'C. 결제 안내', desc:'수동/자동 겸용 · 계약금·잔금 요청 시 · 잔금 미납 2일 후', tag:'수동/자동 겸용', button:'[카드로 결제하기] → #{결제링크}',
    template:'안녕하세요, 드로잉엣홈입니다 🙂\n\n#{고객명}님, 진행 확정해 주셔서 #{금액유형} 안내드릴게요 ✔\n\n계좌이체: 국민은행 015401-04-258798\n(예금주: 장선혜(드로잉엣홈))\n카드결제: #{결제링크}\n금액: #{금액}원\n\n현금영수증 발급을 원하시면 휴대폰 번호를 남겨주세요.\n\n입금 확인 후 다음 단계 안내드릴게요 🙂'},
  t07_final_estimate: {label:'7. 확정 견적서 발송', desc:'수동 · 실측 완료 후', tag:'수동',
    template:'안녕하세요, 드로잉엣홈입니다 🙂\n\n#{고객명}님, 실측 치수를 바탕으로\n최종 견적서를 정리해드렸어요 ✔\n\n실측 사이즈에 따라 가견적과\n금액이 달라질 수 있어요.\n\n잔금 안내는 이어서 드릴게요.\n궁금한 점 있으시면 말씀해 주세요 🙂'},
  // 옛 5번(실측일정확정)+9번(시공일정확정)+18번(AS접수확인) 통합. #{일정유형}=실측/시공/AS
  tB_schedule_confirm: {label:'B. 일정 확정', desc:'수동 · 계약금·잔금 결제 확인 후 · AS 접수 시', tag:'수동',
    template:'안녕하세요, 드로잉엣홈입니다 🙂\n\n#{고객명}님, #{일정유형} 일정을 확정해드렸어요 ✔\n\n일정: #{일정}\n\n정확한 방문 시간은 전날 오후에\n전담팀에서 직접 연락드릴게요.\n\n필요하신 점 있으시면 언제든 말씀해 주세요 🙂'},
  t11_after_install: {label:'11. 시공 후 안부', desc:'자동 · 시공완료 3일 후', tag:'자동', button:'[네이버 리뷰 작성] → 네이버 지도 링크',
  ...
  tD_cancel: {label:'D. 취소 안내', desc:'수동 · 취소 접수 시', tag:'수동',
