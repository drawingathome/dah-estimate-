...
const ALLOWLIST = {
  ...
  'dah_photos': '"시공 사례" 인쇄 섹션용 - 최초 커밋(1d456e2)부터 이 값을 채워주는 UI가 한 번도 없어서 항상 빈 배열, 그 섹션이 한 번도 표시된 적 없는 미완성 기능(2026-09-24 발견). 해롭지는 않음(조용히 무시됨) - 나중에 실제로 이 기능이 필요해지면 그때 UI를 만들지 코드를 지울지 결정. 지금 급하게 정할 문제 아님.'
};
