...
function _showRealtimeUpdateBanner(customer) {
  ...
  banner.innerHTML = '📡 이 고객 정보가 다른 곳에서 방금 업데이트됐어요' +
    '<button id="realtime-refresh-btn" style="background:#fff;color:#282828;border:none;border-radius:10px;padding:5px 10px;font-size:11px;font-weight:700;cursor:pointer;font-family:inherit">새로고침</button>' +
